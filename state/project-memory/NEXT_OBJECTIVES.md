...
- `output/archive/` is documented as backup/reference-only;
...
Trading export state is currently ambiguous across live `automation/` and `output/archive/`.
...
- Do not treat `output/archive/` as live source.
